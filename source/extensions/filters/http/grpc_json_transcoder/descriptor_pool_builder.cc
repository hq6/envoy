...
void DescriptorPoolBuilder::requestDescriptorPool(
  ...
  case envoy::extensions::filters::http::grpc_json_transcoder::v3::GrpcJsonTranscoder::
    ...
    std::cout << "MERLIN MERLIN file proto before loadFileDescriptorProtos" << std::endl;
    loadFileDescriptorProtos(descriptor_set);
    std::cout << "MERLIN MERLIN file proto after loadFileDescriptorProtos" << std::endl;
    break;
  case envoy::extensions::filters::http::grpc_json_transcoder::v3::GrpcJsonTranscoder::
    ...
    std::cout << "MERLIN MERLIN before loadFileDescriptorProtos" << std::endl;
    loadFileDescriptorProtos(descriptor_set);
    std::cout << "MERLIN MERLIN after loadFileDescriptorProtos" << std::endl;
    break;
  case envoy::extensions::filters::http::grpc_json_transcoder::v3::GrpcJsonTranscoder::
