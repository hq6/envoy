...
protected:
  // TODO: Decide whether to move this function into a common header with
  // json_transcoder_filter_test, or to remove it from the latter.
  ...
  // TODO: Decide whether to move this this function into a common header with
  // json_transcoder_filter_test.
